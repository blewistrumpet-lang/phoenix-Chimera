#!/bin/bash
# Build script for ShimmerReverb Engine 40 diagnostic test
...
echo "Building ShimmerReverb Diagnostic Test..."
echo "=========================================="
...
# Compile test
echo "Compiling test_shimmer_diagnostic.cpp..."
$CXX $CPP_FLAGS $INCLUDES $DEFINES -c test_shimmer_diagnostic.cpp -o "$BUILD_DIR/test_shimmer_diagnostic.o"
...
# Link
echo "Linking test_shimmer_diagnostic..."
$CXX $CPP_FLAGS \
    "$BUILD_DIR/test_shimmer_diagnostic.o" \
    "$BUILD_DIR/EngineFactory.o" \
    "$BUILD_DIR/ShimmerReverb.o" \
    "$BUILD_DIR"/*.o \
    $FRAMEWORKS \
    -L/opt/homebrew/lib -lharfbuzz \
    -o "$BUILD_DIR/test_shimmer_diagnostic"

echo ""
echo "✓ Build complete: $BUILD_DIR/test_shimmer_diagnostic"
echo ""
