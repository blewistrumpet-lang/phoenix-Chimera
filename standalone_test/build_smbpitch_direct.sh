#!/bin/bash
# Build script for direct SMBPitchShiftFixed test

set -e

echo "Building direct SMBPitchShiftFixed test..."
...
$CXX $CXXFLAGS $INCLUDES $DEFINES -c test_smbpitchshift_direct.cpp -o $BUILD_DIR/test_smbpitchshift_direct.o

echo "Linking..."
$CXX $CXXFLAGS \
    $BUILD_DIR/test_smbpitchshift_direct.o \
    ...
    -o $BUILD_DIR/test_smbpitchshift_direct

echo "Build complete! Executable: $BUILD_DIR/test_smbpitchshift_direct"
