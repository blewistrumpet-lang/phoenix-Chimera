...
#
# Builds the comprehensive CPU benchmark for all 56 engines
#

set -e  # Exit on error

echo "========================================================================"
echo "    Building CPU Benchmark for All 56 Engines"
echo "========================================================================"
echo ""
...
# Output executable
OUTPUT="$BUILD_DIR/cpu_benchmark_all_engines"
...
echo ""
echo "Step 3: Compiling benchmark main..."
MAIN_OBJ="$OBJ_DIR/cpu_benchmark_main.o"
if [ -f "$MAIN_OBJ" ]; then
    echo "  ✓ cpu_benchmark_main.o (cached)"
else
    clang++ $CPP_FLAGS $INCLUDES $DEFINES -c cpu_benchmark_all_engines.cpp -o "$MAIN_OBJ"
fi
...
if [ -f "$OUTPUT" ]; then
    ...
    echo "  cd $BUILD_DIR"
    echo "  ./cpu_benchmark_all_engines"
    echo ""
else
    echo "========================================================================"
    echo "    Build Failed!"
