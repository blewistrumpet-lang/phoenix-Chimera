...
namespace PlateConstants {
    ...
    // Reverb parameters - balanced for quality and stability
    constexpr double MIN_FEEDBACK = 0.70;    // Good minimum for reverb tail
    constexpr double MAX_FEEDBACK = 0.93;    // Allows 2-3 second RT60 tails
    constexpr double DAMPING_SCALE = 0.8;    // Scales user damping for FDN
    constexpr double EARLY_MIX = 0.25;       // Early reflections mix level
    constexpr double LATE_MIX = 0.75;        // Late reverb mix level
