...
public:
    ...
    float attackTime = 0.01f;  // Gate attack in seconds
    float releaseTime = 0.1f;  // Gate release in seconds
    ...
    void updateCoefficients() {
        ...
        envAttackCoeff = 1.0f / (0.001f * sampleRate + 1.0f);  // 1ms attack
        envReleaseCoeff = 1.0f / (0.010f * sampleRate + 1.0f); // 10ms release
    }
