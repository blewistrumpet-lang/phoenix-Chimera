...
ConvolutionReverb::ConvolutionReverb() {
    ...
    m_mixAmount.reset(0.0f);  // Start dry by default
...
void ConvolutionReverb::process(juce::AudioBuffer<float>& buffer) {
    ...
    // Apply moderate input gain reduction to prevent convolution distortion
    ...
    buffer.applyGain(1.43f); // 1/0.7 to compensate input reduction
