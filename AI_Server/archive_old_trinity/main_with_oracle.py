...
from oracle_faiss_fixed import OracleFAISS as Oracle
...
oracle = Oracle(
    index_path="../JUCE_Plugin/GoldenCorpus_v3/faiss_index/corpus_clean.index",  # Clean index
    meta_path="../JUCE_Plugin/GoldenCorpus_v3/faiss_index/metadata_clean.json",  # Clean metadata
    presets_path="../JUCE_Plugin/GoldenCorpus_v3/faiss_index/presets_clean.json"  # Clean corpus
)
