...
async def generate_preset(request: GenerateRequest):
    ...
    try:
        ...
        preset_name = visionary_preset.get('name', 'Generated Preset')
        ...
        calculated_preset = await calculator.optimize_parameters_max_intelligence(visionary_preset['presets'][0], request.prompt)
        progress_task.cancel()  # Stop simulated progress
