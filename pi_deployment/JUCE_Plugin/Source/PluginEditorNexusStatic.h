...
// DISABLED: Voice recording causing crashes
...
private:
    ...
    // DISABLED: Voice recording causing crashes
    // std::unique_ptr<VoiceRecordButton> voiceButton;
    ...
    bool isApplyingTrinityPreset = false;  // Prevents re-entrant engine loads
