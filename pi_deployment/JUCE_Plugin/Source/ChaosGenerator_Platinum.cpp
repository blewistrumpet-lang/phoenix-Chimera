            ...
            for (int ch=0; ch<numCh; ++ch) {
                ...
                switch (target) {
                    ...
                    case ModGenerate:
                        ...
                        // Generate dramatic chaotic audio that's clearly audible
                        // IMPORTANT: Generate audio directly from chaos, not just add to dry
                        wet = (depth * mod * 0.5f) + (dry * 0.5f); // Generate from chaos + mix with input
                        break;
                }
